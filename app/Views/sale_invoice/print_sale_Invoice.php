...
@media print {
    ...
    #print_div {
        ...
        margin: -15mm 5mm 5mm -55mm !important;
        padding: 0 !important;
...
<div class="content-wrapper">
    <div class="page-content">
        ...
        <div class="ibox" id="print_div">
                ...
                <div class="signature-section" style="border-top: none; padding-top: 10px; margin-top: 40px;">
...
<script>
    ...
    function backToInvoice() {
        ...
        window.location.href = '<?php echo base_url('sale/index'); /* Or your list page */ ?>';
    }
</script>
