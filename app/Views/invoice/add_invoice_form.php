...
<?php echo form_open_multipart("/invoice/saveInvoice", array("id" => "invoice_form", "class" => "general-form", "role" => "form")); ?>
...
<div class="modal-body clearfix ibox-body">
    <div class="row">
        <div class="col-lg-4">
            ...
            <select class="form-control customer-select" data-live-search="true" name="customer_id" id="customer" data-rule-required="true" data-msg-required="This field is required.">
        ...
        <div class="col-sm-4 form-group mb-4">
            ...
            <input class="form-control" name="mobile" id="mobile" type="text" data-rule-required="true" data-msg-required="This field is required." readonly>
        </div>

        <div class="col-sm-4 form-group mb-4">
            <label>Address <span class="text-danger">*</span></label>
            <input class="form-control" name="address" id="address" type="text" data-rule-required="true" data-msg-required="This field is required." readonly>
        </div>
    ...
    <div id="item-rows">
        <div class="row item-row">
            ...
            <div class="col-sm-2 form-group">
                ...
                <input class="form-control gross-wt" name="items[0][gross_wt]" type="number"  step="0.01" min="0"  data-rule-required="true" data-msg-required="This field is required.">
            </div>
            <div class="col-sm-2 form-group">
                <label>Rate <span class="text-danger">*</span></label>
                <input class="form-control rate" name="items[0][rate]" type="number"min="0"  step="0.01"   data-rule-required="true" data-msg-required="This field is required.">
            </div>
            <div class="col-sm-2 form-group">
                <label>Amount</label>
...
$(document).ready(function () {
    ...
    $(document).on('click', '.add-item-row', function () {
        ...
        <div class="row item-row">
            ...
            <div class="col-sm-2 form-group">
                <input class="form-control gross-wt" name="items[${rowIndex}][gross_wt]" type="number" step="0.01" min="0"  data-rule-required="true" data-msg-required="This field is required.">
            </div>
            <div class="col-sm-2 form-group">
                <input class="form-control rate" name="items[${rowIndex}][rate]" type="number" min="0" 
                step="0.01" 
    ...
    $('#paymentMode').on('change', function () {
        $('#payment-note').toggle($(this).val()!== 'CASH' ).toggle($(this).val()!== '' );
    }).trigger('change');



    $('#cash_amount, #online_amount').on('input blur', function () {
        updateBalanceAmount();
